...
"""p17 = ["tipo_string" , "identificador" , "fin_sentencia"]
p18 = ["tipo_string" , "identificador" , "operador_asignacion" , "valor_string" , "fin_sentencia"]
p19 = ["identificador" , "operador_asignacion" , "valor_string" , "fin_sentencia"]
p20 = ["tipo_string" , "identificador" , "operador_asignacion" , "parentesis_apertura" , "valor_string" , "parentesis_cierre" , "fin_sentencia"]
p21 = ["identificador" , "operador_asignacion" , "parentesis_apertura" , "valor_string" , "parentesis_cierre" , "fin_sentencia"]"""
...
"""['for', 'parentesis_apertura', 'tipo_entero', 'identificador', 'operador_asignacion', 'numero_entero', 
